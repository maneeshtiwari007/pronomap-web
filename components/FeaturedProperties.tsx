          ...
          <Carousel className="w-full">
            <CarouselContent>
              {properties && properties.map((property: any) => (
                <CarouselItem key={property.id} className="basis-1/5 p-0 m-0">
                  <div
                  ...
                  >
                    ...
                    <div className="p-3 flex-1 flex flex-col justify-between">
                      ...
                      <Link href={'/property/'+property?.slug} className="bg-primary text-white rounded-lg px-3 py-1 font-semibold hover:bg-[#2563eb] transition-colors mt-2 text-xs">View Details</Link>
                    </div>
                  </div>
                </CarouselItem>
              ))}

...
export default function NotFound() {
    return (
        <div className="page-layout dark:bg-black pt-0">
                    ...
                    <div className="w-full justify-center py-4 md:py-8 lg:py-10 xl:py-12 md:flex items-center">
                        <div className="relative z-10">
                            <div className="mb-[60px] lg:mb-[100px] text-center">
                                ...
                                <p className="text-gray-775 text-xl lg:text-2xl font-medium mb-6 lg:mb-8 xl:mb-10">
                                    The link you followed might be broken, or the page may have been moved.
                                </p>
                                <Button variant="default" className="px-6 py-3 rounded-lg font-medium text-sm transition-colors bg-[#0A3C7D] text-white hover:bg-[#2563eb]">
                                    <Link href="/">Home</Link>
                                </Button>
                            </div>
            ...
            <div className="section section-join-us style-2 bg-primary-975 relative hidden">
